...
/**
 * PUBLIC_INTERFACE
 * Simple controller to verify application is up and to expose docs/health/info.
 */
@RestController
@Tag(name = "Hello Controller", description = "Basic endpoints for gmailbackend")
public class HelloController {

    @GetMapping("/")
    @Operation(summary = "Welcome endpoint", description = "Returns a welcome message")
    public String hello() {
        return "Hello, Spring Boot! Welcome to gmailbackend";
    }
    ...
    public String info() {
        return "Spring Boot Application: gmailbackend";
    }
}